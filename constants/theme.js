...
export const FONTS = {
    ...
    h1: { fontFamily: "Poppins-Bold", fontSize: SIZES.h1, lineHeight: scale(36) },
    h2: { fontFamily: "Poppins-Bold", fontSize: SIZES.h2, lineHeight: scale(30) },
    h3: { fontFamily: "Poppins-SemiBold", fontSize: SIZES.h3, lineHeight: scale(22) },
    h4: { fontFamily: "Poppins-SemiBold", fontSize: SIZES.h4, lineHeight: scale(16) },
    h5: { fontFamily: "Poppins-SemiBold", fontSize: SIZES.h5, lineHeight: scale(20) },
    ...
    body5: { fontFamily: "Poppins-Regular", fontSize: SIZES.body5, lineHeight: scale(22) },
};
